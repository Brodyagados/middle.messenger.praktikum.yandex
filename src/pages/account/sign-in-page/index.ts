    ...
    const context = {
        ...
        main: [
            new TextBox({
                ...
                name: 'email', validationType: ValidationType.EMAIL
            }).getContentAsString(),
            new TextBox({
                label: 'Логин', placeholder: 'Логин',
                name: 'login', validationType: ValidationType.LOGIN
            }).getContentAsString(),
            new TextBox({
                label: 'Имя', placeholder: 'Имя',
                name: 'first_name', validationType: ValidationType.USER
            }).getContentAsString(),
            new TextBox({
                label: 'Фамилия', placeholder: 'Фамилия',
                name: 'second_name', validationType: ValidationType.USER
            }).getContentAsString(),
            new TextBox({
                label: 'Телефон', placeholder: 'Телефон',
                name: 'phone', validationType: ValidationType.PHONE
            }).getContentAsString(),
            new TextBox({
            ...
            new TextBox({
                label: 'Пароль еще раз', placeholder: 'Пароль еще раз',
                name: 'password_equal', type: 'password',
                validationType: ValidationType.EQUAL_PASSWORD
            }).getContentAsString()
        ],
        footer: [
            new Button({
                class: 'button_color_blue', text: 'Зарегистрироваться',
