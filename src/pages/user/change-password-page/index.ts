...
export const ChangePasswordPage = () => {
    const context = {
        main: [
            new TextBox({
                class: 'textbox_inline', label: 'Старый пароль',
                name: 'oldPassword', type: 'password',
                validationType: ValidationType.PASSOWRD
            }).getContentAsString(),
            new TextBox({
                class: 'textbox_inline', label: 'Новый пароль',
                name: 'newPassword', type: 'password',
                validationType: ValidationType.PASSOWRD
            }).getContentAsString(),
            new TextBox({
                class: 'textbox_inline', label: 'Новый пароль еще раз',
                name: 'newPassword_equal', type: 'password',
                validationType: ValidationType.PASSOWRD
            }).getContentAsString()
        ],
        footer: [
